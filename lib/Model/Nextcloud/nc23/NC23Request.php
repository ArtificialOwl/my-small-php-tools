 ...
 */
class NC23Request extends Request {
	...
	/**
	 * @return NC23RequestResult
	 */
	public function getResult(): NC23RequestResult {
		return $this->result;
	}

	/**
	 * @param NC23RequestResult $result
	 *
	 * @return self
	 */
	public function setResult(NC23RequestResult $result): self {
