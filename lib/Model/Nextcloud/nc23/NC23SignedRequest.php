...
/**
 * Class NC23SignedRequest
 *
 * @package ArtificialOwl\MySmallPhpTools\Model\Nextcloud\nc23
 */
class NC23SignedRequest implements JsonSerializable {
	...
	/**
	 * NC23Request of the outgoint request
	 * outgoing
	 *
	 ...
	 * @return NC23SignedRequest
	 */
	public function setOutgoingRequest(NC23Request $request): self {
	 ...
	 * @return NC23Request
	 */
	public function getOutgoingRequest(): NC23Request {
	 ...
	 */
	public function setSignatory(NC23Signatory $signatory): void {
	 ...
	 */
	public function getSignatory(): NC23Signatory {
