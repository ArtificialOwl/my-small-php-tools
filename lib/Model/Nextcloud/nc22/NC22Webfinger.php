 ...
 */
class NC22Webfinger implements JsonSerializable {
	...
	public function __construct(array $json = []) {
		...
		foreach ($this->getArray('links', $json) as $link) {
			$this->addLink(new NC22WellKnownLink($link));
		}
	}
	...
	public function addLink(NC22WellKnownLink $link): self {
		$this->links[] = $link;
